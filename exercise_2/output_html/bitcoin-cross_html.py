...
df3.to_html('output_html/top20_exchanges_wrt_turnover.html')
df4.to_html('output_html/bottom20_exchanges_wrt_turnover.html')
...
df16.head(20).to_html('output_html/top20_exchanges_wrt_traded_pairs.html')
df16.tail(20).to_html('output_html/bottom20_exchanges_wrt_traded_pairs.html')
...
df7.to_html('output_html/cheapest_20_pairs.html')
df8.to_html('output_html/expensive_20_pairs.html')
...
df10.head(10).to_html('output_html/most_traded_pairs_wrt_exchanges.html')
df10.tail(10).to_html('output_html/least_traded_pairs_wrt_exchanges.html')
...
df13.to_html('output_html/most_traded_pairs_wrt_turnover.html')
df14.to_html('output_html/least_traded_pairs_wrt_turnover.html')
